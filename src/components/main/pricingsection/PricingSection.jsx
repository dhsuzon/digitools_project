    ...
    <div className="bg-[#F9FAFC] py-20">
      <div className="max-w-7xl mx-auto px-6 md:px-15">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-black text-[#101727] mb-4">
          ...
          {pricingData.map((plan) => (
            <div
              ...
              className={`relative p-8 rounded-3xl border transition-all duration-300 ${
                plan.isPopular
                  ? "bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white shadow-2xl shadow-purple-500/30 scale-105 z-10 py-12"
                  : "bg-white  border-white shadow-sm"
              }`}
            >
              {plan.isPopular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#FEF3C6] text-[#BB4D00] text-sm font-medium px-4 py-1.5 rounded-full uppercase tracking-widest shadow-md">
                  Most Popular
                </div>
              )}
